...
root_agent = Agent(
    ...
    instruction=(
        ...
        "   After video-init confirms the video name, share the live preview URL with the user:\n"
        "   'You can preview this video as it builds at: http://localhost:8080/preview/<unit>/<lesson_slug>/<video_name>\n"
        "   It updates automatically after each pipeline stage.'\n"
        "   (On Cloud Run, substitute the IAP URL for http://localhost:8080.)\n"
